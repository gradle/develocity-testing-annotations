...
tasks.test {
    retry {
        filter {
            includeAnnotationClasses.add("com.gradle.enterprise.testing.annotations.Retry")
            excludeAnnotationClasses.add("com.gradle.enterprise.testing.annotations.NoRetry")
        }
    }
}
----
